...
import com.hhi.sap.analysis.daily.{ANL_THD_ZPSCT600_R, ANL_ZPDCT6023, ANL_ZPDCT6123}
import com.hhi.sap.analysis.monthly.{ANL_THD_AMT_MONTH, ANL_THD_MRPL_MONTH, ANL_THD_WEIGHT_MONTH}
import com.hhi.sap.analysis.weekly._
...
//  val tb_MRPL_WEEK = ss.sqlContext.sql(SQL_MASTER.MRPL_WEEK.SQL_ALLDATA_MRPL_WEEK)
  ...
  //13,14,15: Monthly
  val df_MRPL_MONTH = new ANL_THD_MRPL_MONTH(ss.sqlContext).run(tb_ZPDCT6123.select(TERM_MASTER.ZPDCT6123.COMPANYID, TERM_MASTER.ZPDCT6123.SAUPBU, TERM_MASTER.ZPDCT6123.PSPID, TERM_MASTER.ZPDCT6123.STG_GUBUN, TERM_MASTER.ZPDCT6123.MAT_GUBUN, TERM_MASTER.ZPDCT6123.MONTH))
  val df_WEIGHT_MONTH = new ANL_THD_WEIGHT_MONTH(ss.sqlContext).run(
    ...
    , tb_MARA.select(TERM_MASTER.MARA.COMPANYID, TERM_MASTER.MARA.SAUPBU, TERM_MASTER.MARA.MATNR, TERM_MASTER.MARA.BRGEW))
  val df_AMOUNT_MONTH = new ANL_THD_AMT_MONTH(ss.sqlContext).run(
  ...
  //16,17,18: Cumulative Table Weekly
  val df_MRPL_WEEK_SUM = new ANL_THD_MRPL_WEEK_SUM(ss.sqlContext).run(tb_ZPDCT6123.select(TERM_MASTER.ZPDCT6123.COMPANYID, TERM_MASTER.ZPDCT6123.SAUPBU, TERM_MASTER.ZPDCT6123.PSPID, TERM_MASTER.ZPDCT6123.STG_GUBUN, TERM_MASTER.ZPDCT6123.MAT_GUBUN, TERM_MASTER.ZPDCT6123.WEEK))
  val df_WEIGHT_WEEK_SUM = new ANL_THD_WEIGHT_WEEK_SUM(ss.sqlContext).run(
    tb_ZPDCT6023.select(TERM_MASTER.ZPDCT6023.COMPANYID, TERM_MASTER.ZPDCT6023.SAUPBU, TERM_MASTER.ZPDCT6023.PSPID, TERM_MASTER.ZPDCT6023.STG_GUBUN, TERM_MASTER.ZPDCT6023.MAT_GUBUN, TERM_MASTER.ZPDCT6023.MATNR, TERM_MASTER.ZPDCT6023.IDNRK, TERM_MASTER.ZPDCT6023.MENGE, TERM_MASTER.ZPDCT6023.BRGEW, TERM_MASTER.ZPDCT6023.WEEK)
    , tb_MARA.select(TERM_MASTER.MARA.COMPANYID, TERM_MASTER.MARA.SAUPBU, TERM_MASTER.MARA.MATNR, TERM_MASTER.MARA.BRGEW))
  val df_AMOUNT_WEEK_SUM = new ANL_THD_AMT_WEEK_SUM(ss.sqlContext).run(
    tb_ZPDCT6123.select(TERM_MASTER.ZPDCT6123.COMPANYID, TERM_MASTER.ZPDCT6123.SAUPBU, TERM_MASTER.ZPDCT6123.PSPID, TERM_MASTER.ZPDCT6123.STG_GUBUN, TERM_MASTER.ZPDCT6123.MAT_GUBUN, TERM_MASTER.ZPDCT6123.IDNRK, TERM_MASTER.ZPDCT6123.MENGE, TERM_MASTER.ZPDCT6123.MEINS, TERM_MASTER.ZPDCT6123.WERKS, TERM_MASTER.ZPDCT6123.WEEK)
    , tb_MARA.select(TERM_MASTER.MARA.COMPANYID, TERM_MASTER.MARA.SAUPBU, TERM_MASTER.MARA.MATNR, TERM_MASTER.MARA.MEINS, TERM_MASTER.MARA.ZZMGROUP)
    , tb_MARC.select(TERM_MASTER.MARC.COMPANYID, TERM_MASTER.MARC.SAUPBU, TERM_MASTER.MARC.MATNR, TERM_MASTER.MARC.SBDKZ, TERM_MASTER.MARC.WERKS)
    , tb_QBEW.select(TERM_MASTER.QBEW.COMPANYID, TERM_MASTER.QBEW.SAUPBU, TERM_MASTER.QBEW.MATNR, TERM_MASTER.QBEW.VERPR, TERM_MASTER.QBEW.PEINH, TERM_MASTER.QBEW.WERKS, TERM_MASTER.QBEW.PSPID, TERM_MASTER.QBEW.SOBKZ, TERM_MASTER.QBEW.MATNR)
  ...
  //19,20,21:
  val df_MRPL_MONTH_SUM = new ANL_THD_MRPL_MONTH_SUM(ss.sqlContext).run(tb_ZPDCT6123.select(TERM_MASTER.ZPDCT6123.COMPANYID, TERM_MASTER.ZPDCT6123.SAUPBU, TERM_MASTER.ZPDCT6123.PSPID, TERM_MASTER.ZPDCT6123.STG_GUBUN, TERM_MASTER.ZPDCT6123.MAT_GUBUN, TERM_MASTER.ZPDCT6123.WEEK))
  val df_WEIGHT_MONTH_SUM = new ANL_THD_WEIGHT_MONTH_SUM(ss.sqlContext).run(
    tb_ZPDCT6023.select(TERM_MASTER.ZPDCT6023.COMPANYID, TERM_MASTER.ZPDCT6023.SAUPBU, TERM_MASTER.ZPDCT6023.PSPID, TERM_MASTER.ZPDCT6023.STG_GUBUN, TERM_MASTER.ZPDCT6023.MAT_GUBUN, TERM_MASTER.ZPDCT6023.MATNR, TERM_MASTER.ZPDCT6023.IDNRK, TERM_MASTER.ZPDCT6023.MENGE, TERM_MASTER.ZPDCT6023.BRGEW, TERM_MASTER.ZPDCT6023.WEEK)
    , tb_MARA.select(TERM_MASTER.MARA.COMPANYID, TERM_MASTER.MARA.SAUPBU, TERM_MASTER.MARA.MATNR, TERM_MASTER.MARA.BRGEW))
  val df_AMOUNT_MONTH_SUM = new ANL_THD_AMT_MONTH_SUM(ss.sqlContext).run(
    tb_ZPDCT6123.select(TERM_MASTER.ZPDCT6123.COMPANYID, TERM_MASTER.ZPDCT6123.SAUPBU, TERM_MASTER.ZPDCT6123.PSPID, TERM_MASTER.ZPDCT6123.STG_GUBUN, TERM_MASTER.ZPDCT6123.MAT_GUBUN, TERM_MASTER.ZPDCT6123.IDNRK, TERM_MASTER.ZPDCT6123.MENGE, TERM_MASTER.ZPDCT6123.MEINS, TERM_MASTER.ZPDCT6123.WERKS, TERM_MASTER.ZPDCT6123.WEEK)
    , tb_MARA.select(TERM_MASTER.MARA.COMPANYID, TERM_MASTER.MARA.SAUPBU, TERM_MASTER.MARA.MATNR, TERM_MASTER.MARA.MEINS, TERM_MASTER.MARA.ZZMGROUP)
    , tb_MARC.select(TERM_MASTER.MARC.COMPANYID, TERM_MASTER.MARC.SAUPBU, TERM_MASTER.MARC.MATNR, TERM_MASTER.MARC.SBDKZ, TERM_MASTER.MARC.WERKS)
    , tb_QBEW.select(TERM_MASTER.QBEW.COMPANYID, TERM_MASTER.QBEW.SAUPBU, TERM_MASTER.QBEW.MATNR, TERM_MASTER.QBEW.VERPR, TERM_MASTER.QBEW.PEINH, TERM_MASTER.QBEW.WERKS, TERM_MASTER.QBEW.PSPID, TERM_MASTER.QBEW.SOBKZ, TERM_MASTER.QBEW.MATNR)
