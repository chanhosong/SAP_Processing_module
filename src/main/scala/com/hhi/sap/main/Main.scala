...
//  val tb_MRPL_WEEK = ss.sqlContext.sql(SQL_MASTER.MRPL_WEEK.SQL_ALLDATA_MRPL_WEEK)
  ...
  val df_WEIGHT_WEEK = new ANL_THD_WEIGHT_WEEK(ss.sqlContext).run(tb_ZPDCT6023.select(TERM_MASTER.ZPDCT6023.COMPANYID, TERM_MASTER.ZPDCT6023.SAUPBU, TERM_MASTER.ZPDCT6023.PSPID, TERM_MASTER.ZPDCT6023.STG_GUBUN, TERM_MASTER.ZPDCT6023.MAT_GUBUN, TERM_MASTER.ZPDCT6023.WEEK))
