...
class ANL_THD_MRPL_MONTH_SUMTest extends FlatSpec {
  ...
  "MRPL_MONTH_SUM" should "make dataframe." in new SparkFileReader {
    ...
    new ANL_THD_MRPL_MONTH_SUM(ss.sqlContext).run(
