...
class ANL_THD_MRPL_WEEK_SUMTest extends FlatSpec {
  ...
  "MRPL_WEEK_SUM" should "make dataframe." in new SparkFileReader {
    ...
    new ANL_THD_MRPL_WEEK_SUM(ss.sqlContext).run(tb_ZPDCT6123
