...
class ANL_THD_WEIGHT_WEEKTest extends FlatSpec with SparkSessionTestWrapper{
  ...
  "ZPDCT6023 " should "make dataframe." in new SparkFileReader {
    ...
    new ANL_THD_MRPL_WEEK(ss.sqlContext).run(tb_ZPDCT6023
      .select(TERM_MASTER.ZPDCT6023.COMPANYID, TERM_MASTER.ZPDCT6023.SAUPBU, TERM_MASTER.ZPDCT6023.PSPID, TERM_MASTER.ZPDCT6023.STG_GUBUN, TERM_MASTER.ZPDCT6023.MAT_GUBUN, TERM_MASTER.ZPDCT6023.WEEK))
      .show()
  }
}